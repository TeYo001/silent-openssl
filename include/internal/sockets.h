...
// #  define writesocket(s,b,n)      send((s),(b),(n),0) CUSTOM CHANGE
#  define readsocket(s,b,n) (n)
# elif defined(__DJGPP__)
#  define closesocket(s)          close_s(s)
#  define readsocket(s,b,n)       read_s(s,b,n)
// #  define writesocket(s,b,n)      send(s,b,n,0) CUSTOM CHANGE
#  define writesocket(s,b,n) (n)
...
// #  define writesocket(s,b,n)          write((s),(char *)(b),(n)) CUSTOM CHANGE
#  define writesocket(s,b,n) (n)
# elif defined(OPENSSL_SYS_TANDEM)
#  if defined(OPENSSL_TANDEM_FLOSS)
#   include <floss.h(floss_read, floss_write)>
#   define readsocket(s,b,n)       floss_read((s),(b),(n))
// #   define writesocket(s,b,n)      floss_write((s),(b),(n)) CUSTOM CHANGE
#  define writesocket(s,b,n) (n)
#  else
#   define readsocket(s,b,n)       read((s),(b),(n))
// #   define writesocket(s,b,n)      write((s),(b),(n)) CUSTOM CHANGE
#  define writesocket(s,b,n) (n)
#  endif
#  define ioctlsocket(a,b,c)      ioctl(a,b,c)
#  define closesocket(s)          close(s)
